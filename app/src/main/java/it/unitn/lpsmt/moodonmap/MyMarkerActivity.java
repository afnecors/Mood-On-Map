    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener = new VolleyResponseListener() {
            ...
            public void onResponse(JSONArray response) {
                ...
                numberOfMarkers[0] = response.length();    // solo per adesso, finchè l'if è commentato!!!
                Log.wtf("AWWW", "" + numberOfMarkers);
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        //if(android_id.equals(jo.getString("id_device")) && jo.getInt("visible") == 1) {
                            ...
                            Log.wtf("Kraken seeking for answers ", oldTitle.get(i) + oldLat.get(i));
                        //}
        ...
        Log.wtf("AWWW 666", "" + numberOfMarkers);
        ...
        Location[] usersLocation = new Location[numberOfMarkers[0]];
        for (int i = 0; i < numberOfMarkers[0]; i++) {
        ...
        ImageButton[] emojiArray = new ImageButton[numberOfMarkers[0]];
        TextView[] messageArray = new TextView[numberOfMarkers[0]];
        TextView[] distanceArray = new TextView[numberOfMarkers[0]];
        Button[] buttonDirectionsArray = new Button[numberOfMarkers[0]];
        View[] line = new View[numberOfMarkers[0]];
